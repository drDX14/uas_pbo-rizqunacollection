...
<head>
  ...
  <title>Dashboard Admin - Rizquna Collection  </title>
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      <a href="index.php" class="logo">
        <span class="logo-mini"><b>Toko</b> Rizquna Collection</span>
        <span class="logo-lg"><b>Toko</b> Rizquna Collection</span>
      </a>
