		...
		<div class="row">
			...
			<div class="col-md-3 col-sm-6 col-xs-6">
				<div class="footer">
					...
					<p>RIZQUNA Collection 1
Pasar Pon Siwalan Kios No. 01, Jl. Raya Mlarak Sambit, Siwalan 2, Siwalan, Kec. Mlarak, Kabupaten Ponorogo, Jawa Timur 63472</p>
			...
			<div class="col-md-3 col-sm-6 col-xs-6">
				<div class="footer">
					...
					<ul class="list-links">
						<li><a href="#">Tentang (Stay Tuned)</a></li>
						<li><a href="#">Pengiriman (Stay Tuned)</a></li>
						<li><a href="#">Tracking Resi (Stay Tuned)</a></li>
					</ul>
				</div>
			</div>
			<!-- /footer widget -->
